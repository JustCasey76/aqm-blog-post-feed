...
define('AQM_BLOG_POST_FEED_VERSION', '1.0.59');
    ...
    if ($posts->have_posts()) {
        while ($posts->have_posts()) {
            ...
            if ($layout_type === 'list') {
                ...
                $html .= '<div class="aqm-card-image" style="background-image: url(' . esc_url($thumbnail_url) . '); background-size: contain; background-repeat: no-repeat;"></div>';
